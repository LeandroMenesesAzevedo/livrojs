...
frm.addEventListener(
    "submit", (e) =>{
        ...
        const mod = frm.inModelo.value // pegando o valor do campo do nome modelo do veículo
        ...
        const parcelado = preco/ 12 //  calculando o valor parcelado

        resp1.innerText = `Promoção do carro da marca: ${marca}`
        resp2.innerText = `O medolo do carro é: ${mod}`
        ...
        e.preventDefault() // envio do fomr
